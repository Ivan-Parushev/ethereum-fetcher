...
export class createUsersTable1678103881975 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "users_transactions_transactions" ("usersId" integer NOT NULL, "transactionTransactionHash" character varying NOT NULL, CONSTRAINT "PK_ab9c67b374ae230467053f6cc83" PRIMARY KEY ("usersId", "transactionTransactionHash"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_93b4d034045239b2976c7e859e" ON "users_transactions_transactions" ("usersId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_0f5c7e5b3716773acb7ffa1418" ON "users_transactions_transactions" ("transactionTransactionHash") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "users_transactions_transactions" ADD CONSTRAINT "FK_0f5c7e5b3716773acb7ffa14187" FOREIGN KEY ("transactionTransactionHash") REFERENCES "transactions"("transactionHash") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
